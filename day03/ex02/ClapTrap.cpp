...
{
	std::cout << "what was I made for? I AM A CLAPTRAP" << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &src)
{
	std::cout << "i'm just a copy of another ClapTrap... " << std::endl;
	*this = src;
}
...
ClapTrap::ClapTrap(const std::string name): name(name), hit_points(10), energy_points(10), attack_damage(0)
{
	...
	std::cout << "i am born... but born isn't my name. Cause my name is " << this->get_name() << "and I AM A CLAP TRAP" << std::endl;
}
